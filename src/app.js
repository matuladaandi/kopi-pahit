document.addEventListener("alpine:init", () => {
  // nama nya adalah products
  Alpine.data("products", () => ({
    items: [
      { id: 1, name: "Robusta Brazil", img: "1.jpg", price: 20000 },
      { id: 2, name: "Arabic Blend", img: "2.jpg", price: 25000 },
  ...
  Alpine.store("cart", {
    ...
    add(newItem) {
      ...
      if (!cartItem) {
        ...
        // jika barang sudah ada, cek apakah barang yang berbeda atau sama dengan yang ada di cart
